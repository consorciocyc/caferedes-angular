...
import { cotizacionModel } from "../../models/cotizacion.models";
...
@Component({
  ...
  providers: [ListService, DatatablesService, CotizacionService, PermitsService]
})
export class CotizacionComponent implements OnInit {
  ...
  public cotizacionmodel: cotizacionModel;
  ...
  public permisos;
  public validateHead = new cotizacionModel();
  ...
  handleClick(event) {
    ...
    this.cotizacionService.search_purchases_unit(params).subscribe(
      res => {
        ...
        this.cotizacionmodel = res.purchases;
  ...
  delete(index, event) {
    ...
    if (data != "") {
      this.cotizacionService.delete(json).subscribe(
        res => {
  ...
  inser_purchase() {
    ...
    let detail_purchase = {
      ...
      head: this.cotizacionmodel,
      user: this.user.identification,
      contract: this.contract,
      company: this.company
    };

    this.cotizacionService.insert(detail_purchase).subscribe(
      res => {
        this.cotizacionmodel.consecutive_purc = res.consecutive_purc;
  ...
  imprimir() {
    window.open(
      this.url_api +
        "purchase/print?idpurchases=" +
        this.cotizacionmodel.idpurchases
    );
  }
  ...
  update_purchase() {
    ...
    this.cotizacionService.update(detail_purchase).subscribe(
      res => {
